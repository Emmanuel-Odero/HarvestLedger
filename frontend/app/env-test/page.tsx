      ...
      <div className="max-w-4xl mx-auto">
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Verify that environment variables are loaded correctly from the root
            .env file
          </p>
        </div>
        ...
        <div className="grid gap-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Values loaded from the root .env file
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Testing the env utility functions
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
            ...
            <CardContent>
              <div className="space-y-4">
                ...
                <div className="text-sm text-gray-600">
                  <p>
                    <strong>Note:</strong> This page helps verify that:
                  </p>
