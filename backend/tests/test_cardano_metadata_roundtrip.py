"""
Property-based test for Cardano metadata round-trip consistency.
...
class TestMetadataRoundTrip:
    """
    Property-based tests for metadata encoding and decoding.
    ...
    def test_metadata_round_trip_consistency(self, event: SupplyChainEvent):
        """
    ...
    @given(event=supply_chain_event_strategy())
    @settings(max_examples=100)
    def test_json_encoding_round_trip(self, event: SupplyChainEvent):
        """
